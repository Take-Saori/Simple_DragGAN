...
# @click.option('--target', 'target_fname', help='Target image file to project to', required=True)
...
def run_projection(
    ...
    network_pkl = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                               "checkpoints")
    network_pkl = os.path.join(network_pkl,
                               object_model_dict[cur_object]+".pkl")
